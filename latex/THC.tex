...
\usepackage[font={small,it}]{caption}   %for image captions
\graphicspath{{/home/romansandler/Documents/THC/figures/}}
...
Each system consists of $N$ input CA3 neurons and $N$ feedforward filters describing the dynamical input-output relationship between the given CA3 and CA1 neurons %\footnote{So far used the term "feedforward filter". Maybe "input-output (IO) filter" is better?}.
...
\bibliography{THCbib,C:/Users/Roman/Documents/Thesis/THESIS_Latex/biblio}
